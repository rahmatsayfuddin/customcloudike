   		...
   		<ul class="x-navigation x-navigation-horizontal x-navigation-panel">
   			...
   			<li class="xn-icon-button">
   				<a href="#" class="x-navigation-minimize"><span class="big-icon fa-lg fa fa-arrow-circle-o-left" ></span></a>
   			</li>
   			<!-- END TOGGLE NAVIGATION -->
   			<!-- SIGN OUT -->
   			<li class="xn-icon-button pull-right">
   				<a href="<?php echo site_url() ?>/login/logout"><span class="fa fa-sign-out"></span></a>                        
   			</li> 
   			<!-- END SIGN OUT -->
   			<!-- MESSAGES -->
   			<li class="xn-icon-button pull-right">
